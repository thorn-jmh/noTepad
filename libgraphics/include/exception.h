...
/*
 * Function: RaiseTheException
 * Usage: RaiseTheException(&e, name, value);
 * ---------------------------------------
...
void RaiseTheException(exception *e, string name, void *value);
...
#define raise(e) RaiseTheException(&e, #e, NULL)
