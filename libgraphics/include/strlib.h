...
/*
 * Function: FindString
 * Usage: p = FindString(pattern, text, start);
 * ----------------------------------------
 * Beginning at position start in the string text, this
 * function searches for the string pattern and returns the
 * first index at which it appears or -1 if no match is
 * found.
 */
...
//TODO:
/*
* Function: FindAllSubString
* Usage: p = FindAllSubString(pattern, text, start);
* -----------------------------------------
* Find all positions pattern appeard.
*/

int* FindAllSubString(string pattern,string text,int start);
